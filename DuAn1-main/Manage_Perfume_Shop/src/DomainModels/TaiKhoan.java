...
public class TaiKhoan {
    ...
    public TaiKhoan(String idTaiKhoan, String idLoaiNguoiDung, String email, String matKhau, String hoTen, int tinhTrang) {
        this.idTaiKhoan = idTaiKhoan;
        this.idLoaiNguoiDung = idLoaiNguoiDung;
        this.email = email;
        this.matKhau = matKhau;
    ...
    public TaiKhoan(String idLoaiNguoiDung, String email, String matKhau, String hoTen, int tinhTrang) {
        this.idLoaiNguoiDung = idLoaiNguoiDung;
        this.email = email;
        this.matKhau = matKhau;
        this.hoTen = hoTen;
