...
public class HoaDonKhuyenMaiViewRepository {
    ...
    public ArrayList<HoaDonKhuyenMaiView> getList(String idHoaDon) {
        ...
        String sql = "select km.TenKhuyenMai as tenKhuyenMai, km.ChietKhau as chietKhau from KhuyenMai as km inner join HoaDon as hd on km.IDKhuyenMai=hd.IDKhuyenMai where hd.IDHoaDon = ?";
